...
ONNX="task2_rknn/model/act_rknn_4d.onnx"; CALIB="task2_rknn/data/dataset_calib_small.txt"
...
r=rknn.hybrid_quantization_step1(dataset=CALIB, proposal=True, proposal_dataset_size=1)
print("proposal step1 rc=", r)
rknn.release()
